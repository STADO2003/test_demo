...
<div className="card">
  <div className="card-body">
    ...
    <p className="card-text">Includes fresh vegetables and fruits.</p>
    <a href="/Vegetables" className="btn btn-primary">Book</a>
  </div>
</div>
<div className="card">
  <div className="card-body">
    <h5 className="card-title">Milk</h5>
    <p className="card-text">Includes Milk Products.</p>
    <a href="/Milk" className="btn btn-primary">Book</a>
  </div>
</div>
    </Container>
    </>
